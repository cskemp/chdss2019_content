...
This document gives an introduction to mixed effects models.  It's follows Chapter 9 of [R for Psych](https://glennwilliams.me/r4psych/) by Glenn Williams very closely, and the toy data set we'll use is from the same resource.
...
How about a random slope for Subject as well?
