...
So we have a problem -- the residuals tend to increase with `n_obs`. If we had a good fit, we'd be unable to see any structure in the residuals. Probably the main issue here is that the responses use a bounded scale (0 - 9), which means that we shouldn't be fitting a linear model. We'll deal with this in a later section. 
