...
Show picture from paper -- talk about the data

```{r expsummary, message=FALSE}
...
Order here is backwards! First stats and then model. If you're going to build a model, suggest doing so before even running the experiment.
